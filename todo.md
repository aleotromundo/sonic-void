...
- [x] Investigar capacidades oficiales de Bandcamp para descubrimiento, metadata y reproducción embebida.
- [x] Comparar sus límites de API, embeds, permisos y estabilidad con las fuentes actuales.
